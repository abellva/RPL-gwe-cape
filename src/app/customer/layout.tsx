...
import { customerNavItems } from '@/src/features/dashboard/config/nav.config';

export default function CustomerLayout({ children }: { children: React.ReactNode }) {
  const { isLoading, isAuthorized } = useRoleGuard('user');
  ...
  return (
    <DashboardShell theme="customer" navItems={customerNavItems}>
      {children}
    </DashboardShell>
  );
}
